...
Default destination is $XDG_CONFIG_HOME/baqis-quafu/credentials.env, falling back to
~/.config/baqis-quafu/credentials.env, with 0600 file mode. Optional project-local
