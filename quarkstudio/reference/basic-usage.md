...
This skill intentionally covers only the minimal cloud workflow: install/import, initialize `Task`, check status, submit an OpenQASM 2.0 task, and read results.
...
The lesson uses OpenQASM 2.0 strings and a Python dict:
...
1. State backend, circuit, shots, and task name.
